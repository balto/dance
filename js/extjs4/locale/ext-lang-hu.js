...
Ext.onReady(function() {
   ...
   if(Ext.ux.ColorField){
	   	Ext.apply(Ext.ux.ColorField.prototype, {
	   		lengthText         : "A mező csak 3, vagy 6 hosszúságú hexadecimális számot tartalmazhat",
	   		blankText		   : "A mező csak hexadecimális számot tartalmazhat ABCDEF formában"
	    });
   }
   ...
   if(Ext.picker.Month) {
    ...
    if(Ext.form.Basic){
        Ext.form.Basic.prototype.waitTitle = "Kérem várjon...";
    }
    ...
    if(Ext.form.field.Date){
      Ext.apply(Ext.form.field.Date.prototype, {
        ...
        invalidText       : "{0} nem megfelelő dátum - a helyes formátum: éééé-hh-nn",
        format            : "Y m d",
    ...
    if(Ext.form.RadioGroup){
        Ext.apply(Ext.form.RadioGroup.prototype, {
            blankText: "Ebből a csoportból kötelező választani egy elemet!"
        });
    }
