<?php
class RightRelationManager extends CodetableManager
{
    ...
    public static function getInstance()
    {
        if (is_null(self::$instance)) {
            self::$instance = new RightRelationManager();
        }
    ...
    protected function getSelectFields() {
        return array(
            'id', 'name', 'owner', 'is_active', 'UNIX_TIMESTAMP(created_at) as created_at', 'UNIX_TIMESTAMP(updated_at) as updated_at'
        );
    }
