...
$dlg->createModel("CampaignType", $this->campaignTypelistFieldDefinitions());
...
$dlg->add(Ext::GridPanel("Grid")
		...
		->preventHeader(true)
		->collapsible(true)
		->selModel(new ExtCodeFragment("Ext.create('Ext.selection.CheckboxModel', { checkOnly : true, mode : 'SINGLE' })"))
		->height(200)
