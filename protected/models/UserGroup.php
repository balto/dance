...
class UserGroup extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'permissions' => array(self::MANY_MANY, 'Permission', 'user_group_permission(user_group_id, permission_id)'),
			'users' => array(self::MANY_MANY, 'User', 'user_user_group(user_group_id, user_id)'),
		);
	}
